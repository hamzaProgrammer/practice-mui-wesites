...
import HistoryImage from "../assets/images/coffe10.png"
import { Typography } from '../utils';

const Step01 = () => {
    return (
        <>
            <Box className="flex flex-col justify-start py-2 p-1 max-w-[200px] " >
                <Box className="w-[65px] h-[65px] rounded-full bg-[#B87333] flex justify-center items-center px-1 step -mb-6 z-10" >
                    <Typography children="Step 01" className="text-[white] text-sm" />
                </Box>
