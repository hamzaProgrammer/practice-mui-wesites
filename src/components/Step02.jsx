...
import HistoryImage from "../assets/images/coffe8.png"
import { Typography } from '../utils';

const Step02 = () => {
    return (
        <>
            <Box className="flex flex-col justify-start py-2 p-1 max-w-[200px] md:mt-[120px]" >
                <Box className="w-[65px] h-[65px] rounded-full bg-[#B87333] flex justify-center items-center px-1 step -mb-6 z-10" >
                    <Typography children="Step 02" className="text-[white] text-sm" />
                </Box>
